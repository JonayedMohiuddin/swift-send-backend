...
BEGIN 
    ...
    INSERT INTO LOG(MESSAGE) VALUES('ORDER ' || CANCEL_ORDER_ITEM_ID || ' CANCELED');
	RETURN MSG;
...
BEGIN
    ...
    INSERT INTO LOG(MESSAGE) VALUES('CART ITEM ' || CART_ID_VALUE || ' UPDATED');
EXCEPTION
    WHEN NO_DATA_FOUND THEN
...
BEGIN 
    ...
    INSERT INTO LOG(MESSAGE) VALUES('ORDER ' || ORDER_ID_VALUE || ' PLACED');
END;
/
...
BEGIN
    ...
    INSERT INTO LOG(MESSAGE) VALUES('ORDER ' || :NEW.ID || ' ADDED');
EXCEPTION
    WHEN NO_DATA_FOUND THEN
...
BEGIN
    ...
    INSERT INTO LOG(MESSAGE) VALUES('ORDER ' || :OLD.ORDER_ITEM_ID || ' SHIPPED');
...
BEGIN 
    ...
    INSERT INTO LOG(MESSAGE) VALUES('ORDER ' || :OLD.ORDER_ITEM_ID || ' DELIVERED');
